...
//const correo = prompt("Cual es tu correo electronico?")
//console.log(correo.length)

//for(let i = 0; i < correo.length; i++){
    //console.log(correo[i], i)
...
//const numeroTelefonico = Number(prompt("Cual es tu numero telefonico?"))
//console.log(numeroTelefonico)

//for (let i = 0; i < numeroTelefonico.lengh; i++) {
...
//let numeroMin = Number(prompt("deja un numero minimo"))
//let numeroMax = Number(prompt("deja un numero maximo (mayor al minimo que acabas de poner"))

//let suma1 = numeroMin + numeroMax

//for(numeroMin; numeroMin < numeroMax; numeroMin++){
    //console.log(numeroMin)
    //if ((suma1 % 2) == 0){
    //    console.log(`si funciona`)
   // }else if (numeroMin == NaN || numeroMax == NaN || numeroMin == null || numeroMax == null){
